...
!function($){
	...
	$.fn.onepage_scroll = function(options){
		...
		$.fn.goToSectionByName = function () { 
				...
				var sectionsAmount = sections.length;

			// if we found a # in the URL we iterate trough to make it better 
		...
		//    console.log("hash detected :", hash);
				...
				for(var i=0 ; i < sectionsAmount ; i++ ) { 
						...
						var currentSectionDataName  = sections[i].attributes["data-name"].value;
					//  console.log(currentSectionDataName,hash ,currentSectionDataName == hash );
						if (currentSectionDataName == hash ) {
								$.fn.moveTo(i+1);
								index = i;
								break;
						}
			...
			$.fn.replaceHistoryAndGo = function  (settings,position,data) { 
 ...
 $.fn.moveUp = function() {
	...
	//			console.log("moveDown",index, pos,next.data("index") );
				...
				var sectionValue = $('section').eq(index-2).attr("data-name") ;
				history.pushState( {}, document.title, sectionValue );
    ...
    $.fn.moveTo = function(page_index) {
	 ...
	 //   console.log(delta);
		...
		$.each( sections, function(i) {
			...
			if(settings.pagination == true) {
				paginationList += "<li><a style='background:url(/assets/img/"+FBZ.model.iconsList[i]+".svg)' data-index='"+(i+1)+"'></a></li>"
			}
		});
				console.log($(this));
				$(this).css( {
		...
		if (settings.pagination == true) {
			...
			if( settings.direction == 'horizontal' ) {
				...
				el.find(".onepage-pagination").css("margin-left", posLeft);
				 console.log(el.find(".onepage-pagination").index() );
